...
namespace __ServiceName__.Architecture.Tests.Layers
{
     /// <summary>
     ...
     public class LayerTests
     {
          ...
          private const string DomainNamespace = "__ServiceName__.Domain";
          private const string ApplicationNamespace = "__ServiceName__.Application";
          private const string InfrastructureNamespace = "__ServiceName__.Infrastructure";
          private const string PresentationNamespace = "__ServiceName__.API";
